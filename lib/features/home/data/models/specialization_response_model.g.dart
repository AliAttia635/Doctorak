...
DoctorModel _$DoctorModelFromJson(Map<String, dynamic> json) => DoctorModel(
  ...
  specialization: SpecializationSmallModel.fromJson(
...
SpecializationSmallModel _$SpecializationSmallModelFromJson(
  Map<String, dynamic> json,
) => SpecializationSmallModel(
  id: (json['id'] as num).toInt(),
  name: json['name'] as String,
);

Map<String, dynamic> _$SpecializationSmallModelToJson(
  SpecializationSmallModel instance,
